...
**Background removal**
* Improved black background removal system.
* Added a new background removal method `Photoroom API`, which allows you to remove any background of any complexity, but the free plan only allows you to remove up to 10 images that are not updated.
**User interface**
* Improved and optimized user interface.

## Bugs
**Application size**
* Scripts have been optimized and unnecessary lines have been removed that overloaded the application
